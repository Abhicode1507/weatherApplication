...
export default (await import("vue")).defineComponent({
  ...
  async created() {
    console.log('created');
    const response =
      await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${this.city}&units=metric&appid=fac62fb60e74c64727b441ad29b9603c`);
...
.main-div {
  ...
  color: #fff !important;
  background-image: url("https://images.unsplash.com/photo-1569429512518-44dad00e88db?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80") !important;
